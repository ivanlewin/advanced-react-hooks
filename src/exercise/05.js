...
const MessagesDisplay = React.forwardRef(({ messages, scrollToBottom }, ref) => {
  React.useLayoutEffect(scrollToBottom);
  return (
...
function App() {
  ...
  return (
    <div className="messaging-app">
      ...
      <MessagesDisplay ref={messageDisplayRef} messages={messages} scrollToBottom={scrollToBottom} />
      <div>
